...
const SectionMoreWithUs = () => {
    return(
        <>
            <div style={{ backgroundImage: `url(${bg3})` }} className="bg-violet-300 py-8">
                ...
                <div  className="my-10 py-1 container mx-auto px-10 ">
                    ...
                    <div className="sm:flex items-center justify-between">
                        ...
                        <div className='flex items-center my-8 group'>
                            <button className='rounded-full p-2 md:p-3 mr-2 shadow-xl transition-all ease-linear duration-200 bg-blue-600'>
                                <FaAngleRight className='text-lg text-white'/>
                            </button>
                            <a href="#" className='font-medium text-sm transition-all ease-linear duration-200 text-blue-600'>Join Now</a>
                        </div>
